...
void PartConfigGeneralWidget::readSettings(const QString &settingsGroup)
{
	...
	connect(ui.latexUrlRequester, &KUrlRequester::textChanged, this, &PartConfigGeneralWidget::setModified);
	connect(ui.pdftopsUrlRequester, &KUrlRequester::textChanged, this, &PartConfigGeneralWidget::setModified);
	connect(ui.editorUrlRequester, &KUrlRequester::textChanged, this, &PartConfigGeneralWidget::setModified);
	connect(ui.replaceEdit, &KLineEdit::textChanged, this, &PartConfigGeneralWidget::setModified);
}
